...
//       if (response.ok) {
//         vip3Users(vip3Users.filter((user) => user.id !== userId)); // Update the state to remove the deleted user
...
//       if (response.ok) {
//         vip3Users(vip3Users.filter((user) => user.id !== userId)); // Update the state to remove the demoted user
//       } else {
